		...
		image: function()
		{
			return {
				...
				showEdit: function($image)
				{
					...
					$('#redactor-image-width').val($image.attr('width'));
					$('#redactor-image-height').val($image.attr('height'));
		...
		modal: function()
		{
			return {
                ...
                + '<div style="display: inline-block; margin-right: 4px">'
                  + '<label>Ширина</label>'
                  + '<input type="text" style="width: 100px" id="redactor-image-width"/>'
                + '</div>'
                + '<div style="display: inline-block">'
                  + '<label>Высота</label>'
                  + '<input type="text" style="width: 100px" id="redactor-image-height"/>'
                + '</div>'
              + '</div>'
						+ '</section>',
